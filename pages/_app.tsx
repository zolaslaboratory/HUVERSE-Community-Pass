  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content="Mint your HUVERSE Pass to access exclusive feature on HUVERSE."
        />
        <meta
          name="keywords"
          content="Heroes Uprising, NFT, HUVERSE Pass, HUVERSE, heroesuprising, minting"
        />
        {/* Facebook */}
        ...
        <meta property="og:description" content="Mint your HUVERSE Pass to access exclusive feature on HUVERSE."/>
        ...
        <meta name="twitter:description" content="Mint your Community Pass to access exclusive feature on HUVERSE."/>
